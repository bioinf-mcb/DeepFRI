...
def _parse_function_gcn(serialized, n_goterms, channels=26, cmap_type='ca', cmap_thresh=10.0, ont='mf'):
    features = {
        ...
        "labels": tf.io.FixedLenFeature([n_goterms], dtype=tf.int64),
